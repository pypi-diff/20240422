# Comparing `tmp/techmax_energiez_x23176458-0.0.5.tar.gz` & `tmp/techmax_energiez_x23176458-0.1.1.tar.gz`
...
## Comparing `techmax_energiez_x23176458-0.0.5.tar` & `techmax_energiez_x23176458-0.1.1.tar`
...
### Comparing `techmax_energiez_x23176458-0.0.5/setup.py` & `techmax_energiez_x23176458-0.1.1/setup.py`
...
### Comparing `techmax_energiez_x23176458-0.0.5/techmax_energiez_pkg/server_status.py` & `techmax_energiez_x23176458-0.1.1/techmax_energiez_pkg/server_status.py`
