# Comparing `tmp/metadynminer-0.7.0.tar.gz` & `tmp/metadynminer-0.8.0.tar.gz`
...
### Comparing `metadynminer-0.7.0/setup.py` & `metadynminer-0.8.0/setup.py`
...
### Comparing `metadynminer-0.7.0/tests/test_fast.py` & `metadynminer-0.8.0/tests/test_fast.py`
...
### Comparing `metadynminer-0.7.0/tests/test_fep.py` & `metadynminer-0.8.0/tests/test_fep.py`
...
### Comparing `metadynminer-0.7.0/tests/test_orig.py` & `metadynminer-0.8.0/tests/test_orig.py`
...
### Comparing `metadynminer-0.7.0/tests/test_readhills.py` & `metadynminer-0.8.0/tests/test_readhills.py`
