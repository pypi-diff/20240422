# Comparing `tmp/gridengine_framework-0.7.8.tar.gz` & `tmp/gridengine_framework-0.7.9.tar.gz`
...
### Comparing `gridengine_framework-0.7.8/LICENSE` & `gridengine_framework-0.7.9/LICENSE`
